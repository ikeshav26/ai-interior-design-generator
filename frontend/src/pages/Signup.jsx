        ...
        <div className="max-w-md w-full mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-warning">
              ⚠️ Please use a valid, personal email address. If you use fake or
              disposable emails, you won’t be able to recover your account if
          ...
          <div className="max-w-lg">
            ...
            <div className="mt-8 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <p className="text-sm text-white/80">
                💡 <strong>Pro Tip:</strong> Start with simple room descriptions
                like "modern living room" or "cozy bedroom" for best results!
              </p>
            </div>
          </div>
        </div>
